...
// Try jquery function in bookmarklet environment
...
window.bookmarklet.executeMyBookmarklet = function () {
  var options = {
    ...
    ready: function ($) {
      ...
      alert('hi jquery')
      //test ajax: can reach there but ... 
      $.get('http://localhost:3000/webnotes/testurl?url=http://shareup.me', function(data){
        console.log('in ajax') //do not reach here on diffient site, same origin policy restrict???
      })
      alert('after ajax1')
